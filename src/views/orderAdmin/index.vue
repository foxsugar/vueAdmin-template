...
<script>
  ...
  import {findCharges} from "../../api/charges";
  ...
  export default {
    methods: {
      ...
      // setChargeType: function (row, column) {
      //   // return row.chargeType === 0 ? 'A' : row.chargeType === 1 ? '女' : '未知'
      //   return "111"
      // },
      setChargeType(row, column, cellValue){
        row.chargeType == 1 ? "A" : "B"
      },
      fetchOne() {
      },
      handleFilter() {
